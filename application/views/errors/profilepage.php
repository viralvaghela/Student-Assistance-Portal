...
.styledata{
    padding: 10px;
    -webkit-box-shadow: 0px 1px 29px 10px rgba(0,0,0,0.61);
    -moz-box-shadow: 0px 1px 29px 10px rgba(0,0,0,0.61);
    box-shadow: 0px 1px 29px 10px rgba(0,0,0,0.61);
}
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <div class="btn">
             <input type="file" name="upload" class="file-upload" >
          </div>
           <label class="label-control" for="interset">interset</label>
          <select class="form-control" style="width: 140px">
                    <option>Select interst</option>
                    <option>Java</option>
                    <option>C</option>
                    <option>C++</option>
           </select> 
        ...
        <div class="col-sm-7">
          <div class="form-group">
            <label for="name" name="name" class="label-control">Name:: name of the student</label><br><br>
            ...
            <div class="contact">
              <div class="col-sm-6">
                <div class="form-group">
                     <div class="styledata"> <!-- style sheet -->
                      <label for="contact" class="label-control" style="color:green;">Contact</label><br>
                      <div class="contact-border">
                        <label for="name" class="label-control">Name ::</label><br>
                        <label for="email" class="label-control">Email::</label><br>
                        <label for="name" class="label-control">Name::</label><br><br>
                        
                      </div>
                      <div class="address-border">
                        <label for="address" class="label-control">Address::</label><br>
                        <label for="Country" class="label-control">Country::</label><br>
                        <label for="Zipcode" class="label-control">Zip code::</label><br>
                        
                        
                     </div>

                  </div>
                        <button class="btn btn-primary float-right" name="change" type="change" style="margin: 4px;">Change</button>
     ...
     <!--  <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <div class="address-border">
            ...
            <label for="Country" class="label-control">Country</label><br>
            <label for="Zipcode" class="label-control">Zip code</label><br>
            <button class="btn btn-primary float-right" name="change" type="change">Change</button>
